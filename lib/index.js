...
var _afterframe = _interopRequireDefault(require("afterframe"));
...
function cancelableAfterFrame(callback) {
  ...
  (0, _afterframe["default"])(function () {
    if (!handle.cancelled) {
      callback();
    }
  });
...
var supportsScrollBehavior = _canUseDOM["default"] && 'scrollBehavior' in document.createElement('div').style;
  ...
  function ScrollBehavior(_ref) {
    ...
    this._checkWindowScrollPosition = function () {
      return new Promise(function (resolve) {
        ...
        _this._checkWindowScrollCancelled = false;
        (0, _afterframe["default"])(doCheckWindowScrollPosition);
      });
    };
    ...
    _lifecycle["default"].addEventListener('statechange', function (_ref2) {
